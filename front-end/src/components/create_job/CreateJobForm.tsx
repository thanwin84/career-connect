...
import { CountryList, ExperianceLevel, FormData, Job, JobStatus, JobType } from "../../types";
                ...
                <div className="">
                    <div className="lg:flex gap-4">
                        ...
                        <Location 
                            ...
                            jobLocation={methods.formState.defaultValues?.jobLocation as string}
                        />
                        <div className="lg:flex gap-4">
                            <Select 
                        ...
                        <div className="mt-2">
                            ...
                            <SelectOptionsInput 
                                ...
                                className= "mt-4"
                            />
                            <input type="hidden" {...methods.register("experianceLevel", {required: "Please select experiance level"})} />
                            {methods.formState.errors.experianceLevel && (
                                <FormError 
                                    message={methods.formState.errors.experianceLevel?.message as string} 
                                    id="experianceLevel" 
                                />
                            )
                                                                            }
