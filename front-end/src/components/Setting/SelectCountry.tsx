...
export default function SelectCountry({onSelect, selectedCountry, handleBackClick}:Props){
    ...
    return (
        <div className="bg-white dark:bg-zinc-900   rounded-md">
            ...
            <h2 className="px-4 mb-4 text-xl text-slate-800  font-bold dark:text-slate-100">Select a country</h2>
